...
import com.elroi.lemurloop.ui.screen.alarm.AlarmListScreen
import com.elroi.lemurloop.ui.screen.onboarding.OnboardingScreen
...
fun LemurLoopNavGraph(
    ...
    NavHost(
        ...
        composable(
            ...
            com.elroi.lemurloop.ui.screen.alarm.AlarmDetailScreen(
                alarmId = alarmId,
        ...
        composable(Screen.AlarmWizard.route) {
            com.elroi.lemurloop.ui.screen.alarm.AlarmCreationWizard(
                onFinished = { 
        ...
        composable(Screen.SleepTracking.route) {
            com.elroi.lemurloop.ui.screen.sleep.SleepTrackingScreen()
        }
        ...
        composable(Screen.Help.route) {
            com.elroi.lemurloop.ui.screen.settings.HelpScreen(navController = navController)
        }

        composable(Screen.About.route) {
            com.elroi.lemurloop.ui.screen.settings.AboutScreen(
                onNavigateBack = { navController.navigateUp() }
            )
        }

        composable(Screen.DiagnosticLogs.route) {
            com.elroi.lemurloop.ui.screen.settings.DiagnosticLogsScreen(
                onNavigateUp = { navController.navigateUp() }
            )
        }
    }
