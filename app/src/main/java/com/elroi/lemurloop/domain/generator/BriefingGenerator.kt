...
import com.elroi.lemurloop.domain.manager.BriefingStateManager
...
class BriefingGenerator @Inject constructor(
            ...
            val finalResult: String? = when (tier) {
                ...
                "ADVANCED" -> if (preferredTier == "ADVANCED") {
                    try {
                        ...
                        if (status == com.elroi.lemurloop.domain.manager.GeminiNanoStatus.SUPPORTED) {
    ...
    private fun getPersonaInstruction(persona: String, settings: com.elroi.lemurloop.domain.manager.AlarmDefaults): String {
        return when(persona) {
    ...
    private fun getPersonaTemperament(persona: String): com.elroi.lemurloop.domain.manager.PersonaTemperament {
        return when(persona) {
            "COMEDIAN" -> com.elroi.lemurloop.domain.manager.PersonaTemperament.COMEDIAN
            "ZEN" -> com.elroi.lemurloop.domain.manager.PersonaTemperament.ZEN
            "HYPEMAN" -> com.elroi.lemurloop.domain.manager.PersonaTemperament.HYPEMAN
            else -> com.elroi.lemurloop.domain.manager.PersonaTemperament.COACH
        }
    }
    ...
    private fun buildEnhancementPrompt(
        ...
        temperament: com.elroi.lemurloop.domain.manager.PersonaTemperament,
