...
import com.elroi.alarmpal.domain.manager.TextToSpeechManager
import io.mockk.*
...
class SettingsCompactionTest {
    ...
    fun setup() {
        ...
        val alarmDao = mockk<com.elroi.alarmpal.data.local.dao.AlarmDao>(relaxed = true)
        val sleepDao = mockk<com.elroi.alarmpal.data.local.dao.SleepRecordDao>(relaxed = true)
